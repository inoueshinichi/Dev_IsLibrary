...
namespace
{
    TEST(imgproc_func, permissible_circle_of_confusion)
    {
        /*許容錯乱円*/
    ...
    TEST(imgproc_func, cvt_35mm_focus_length)
    {
        /*35mmフィルム換算の焦点距離*/
    ...
    TEST(imgproc_func, lens_category)
    {
        /*レンズカテゴリ*/
        // 0~40mm:広角レンズ
        // 40~100mm:標準レンズ
    ...
    TEST(imgproc_func, angle_of_view)
    {
        /*画角*/
    ...
    TEST(imgproc_func, effective_aperture)
    {
        /*有効口径*/
        double focus_length = 35.0; // 35[mm]
        double f_number = 2.1;
