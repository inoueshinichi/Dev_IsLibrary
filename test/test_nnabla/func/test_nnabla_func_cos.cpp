/**
 * @file test_nnabla_func_cos.cpp
 * @author your name (you@domain.com)
 * @brief [Test] Nnabla cos-func
 * @version 0.1
 * @date 2021-12-17
 * 
...
namespace 
{
    TEST(nnabla_func, cos_1)
    {
        ...
        auto out_ndarray = is::common::invoke_tm_chrono_ms_ret(cos<float>, ndarray_zeros);

        show_ndarray_contents<float>(out_ndarray);
    }


    TEST(nnabla_func, cos_2)
    {
        using namespace std;
        const auto& ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
