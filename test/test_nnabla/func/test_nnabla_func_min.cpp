/**
 * @file test_nnabla_func_min.cpp
 * @author your name (you@domain.com)
 * @brief [Test] Nnabla min-func
 * @version 0.1
 * @date 2021-12-17
 * 
...
namespace 
{
    ...
    TEST(nnabla_func, min_axis_0)
    {
        ...
        // min with axis=0
        auto ndarray_out1 = min<float>(ndarray_in, 0);
    ...
    TEST(nnabla_func, min_axis_1)
    {
        ...
        // min with axis=1
        auto ndarray_out1 = min<float>(ndarray_in, 1);
        auto shape_out1 = ndarray_out1[0]->shape();
        show_ndarray_property(ndarray_out1[0]);
        show_ndarray_contents<float>(ndarray_out1[0]);
    }
    ...
    TEST(nnabla_func, min_axis_2)
    {
        ...
        // min with axis=2
        auto ndarray_out1 = min<float>(ndarray_in, 2);
        auto shape_out1 = ndarray_out1[0]->shape();
        show_ndarray_property(ndarray_out1[0]);
        show_ndarray_contents<float>(ndarray_out1[0]);
    }

     // Min by axis 2, only index
    TEST(nnabla_func, min_axis_2_only_index)
    {
        using namespace std;
        const auto &ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
        ...
        // min with axis=2 only_index
        auto ndarray_out1 = min<float>(ndarray_in, 2, false, false, true);
        auto shape_out1 = ndarray_out1[0]->shape();
        show_ndarray_property(ndarray_out1[0]);
        show_ndarray_contents<ulong>(ndarray_out1[0]);
    }

    // Min by axis 2 with keep_dims
    TEST(nnabla_func, min_axis_2_with_keep_dims)
    {
        using namespace std;
        const auto &ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
        ...
        // min with axis=2
        auto ndarray_out1 = min<float>(ndarray_in, 2, true);
        auto shape_out1 = ndarray_out1[0]->shape();
        show_ndarray_property(ndarray_out1[0]);
        show_ndarray_contents<float>(ndarray_out1[0]);
    }

     // Min by axis 2 with keep_dims & with_index
    TEST(nnabla_func, min_axis_2_with_keep_dims_with_index)
    {
        using namespace std;
        const auto &ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
        ...
        // min with axis=2
        auto ndarray_out_vec = min<float>(ndarray_in, 2, true, true);
