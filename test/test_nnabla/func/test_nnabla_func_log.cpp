/**
 * @file test_nnabla_func_log.cpp
 * @author your name (you@domain.com)
 * @brief [Test] Nnabla log-func
 * @version 0.1
 * @date 2022-01-05
 * 
...
namespace 
{
    TEST(nnabla_func, log_1)
    {
        ...
        auto out_ndarray = is::common::invoke_tm_chrono_ms_ret(log<float>, ndarray_zeros);
