/**
 * @file test_nnabla_func_asinh.cpp
 * @author your name (you@domain.com)
 * @brief [Test] Nnabla asinh-func
 * @version 0.1
 * @date 2021-12-17
 * 
...
namespace 
{
    TEST(nnabla_func, asinh_1)
    {
        ...
        auto out_ndarray = is::common::invoke_tm_chrono_ms_ret(asinh<float>, ndarray_zeros);

        show_ndarray_contents<float>(out_ndarray);
    }


    TEST(nnabla_func, asinh_2)
    {
        using namespace std;
        const auto& ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
