/**
 * @file test_nnabla_func_log2.cpp
 * @author your name (you@domain.com)
 * @brief [Test] Nnabla log2-func
 * @version 0.1
 * @date 2022-01-05
 * 
...
namespace 
{
    TEST(nnabla_func, log2_1)
    {
        ...
        auto out_ndarray = is::common::invoke_tm_chrono_ms_ret(log2<float>, ndarray_zeros);

        show_ndarray_contents<float>(out_ndarray);
    }

    TEST(nnabla_func, log2_2)
    {
        using namespace std;
        const auto& ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
