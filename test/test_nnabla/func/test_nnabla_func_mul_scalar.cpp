/**
 * @file test_nnabla_func_mul_scalar.cpp
 * @author your name (you@domain.com)
 * @brief [Test] Nnabla mul_scalar-func
 * @version 0.1
 * @date 2021-12-12
 * 
...
namespace 
{
    TEST(nnabla_func, mul_scalar_1)
    {
        ...
        auto out_ndarray = mul_scalar<float>(ndarray_adds, 3);

        show_ndarray_contents<float>(out_ndarray);
    }

    TEST(nnabla_func, mul_scalar_2)
    {
        using namespace std;
        const auto &ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
