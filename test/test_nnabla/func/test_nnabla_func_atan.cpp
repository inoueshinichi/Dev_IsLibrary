/**
 * @file test_nnabla_func_atan.cpp
 * @author your name (you@domain.com)
 * @brief [Test] Nnabla atan-func
 * @version 0.1
 * @date 2021-12-17
 * 
...
namespace 
{
    TEST(nnabla_func, atan_1)
    {
        ...
        auto out_ndarray = is::common::invoke_tm_chrono_ms_ret(atan<float>, ndarray_zeros);

        show_ndarray_contents<float>(out_ndarray);
    }


    TEST(nnabla_func, atan_2)
    {
        using namespace std;
        const auto& ctx_cpu = SingletonManager::get<GlobalContext>()->get_current_context();
